...
class CentralPanel(QWidget):
    def __init__(self, parent=None):
        ...
        sub_container = Container(self.update_view)
        self.container.addWidget(sub_container)
        sub_sub_container = Container(self.update_view)
        self.container.addWidget(sub_sub_container)
