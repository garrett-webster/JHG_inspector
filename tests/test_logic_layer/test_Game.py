...
class TestGameInitialization:
    def test_init_valid_path(self, game):
        test_game = game(FILE_PATH.parent.parent / "test_data" / "test_set1/jhg_GDHP.json")
        assert test_game.code == "GDHP"

    def test_init_invalid_path(self, game_set, temp_folder):
        with pytest.raises(FileNotFoundError):
            Game(game_set().database).load_from_file(Path("../test_data/test_set1/jhg_AAAA.json"))

    def test_set_id_to_name_dicts(self, game):
        test_game1 = game(FILE_PATH.parent.parent / "test_data" / "test_set1/jhg_GDHP.json")
        test_game2 = game(FILE_PATH.parent.parent / "test_data" / "test_set1/jhg_MGNP.json")
    ...
    def test_load_from_file(self, game):
        test_game1 = game(FILE_PATH.parent.parent / "test_data" / "test_set1/jhg_GDHP.json")
        test_game2 = game(FILE_PATH.parent.parent / "test_data" / "test_set1/jhg_MGNP.json")
        test_game3 = game(FILE_PATH.parent.parent / "test_data" / "test_set1/jhg_GDHP.json")
    ...
    def test_load_from_database(self, game, game_set):
        game(FILE_PATH.parent.parent / "test_data" / "test_set1/jhg_GDHP.json")
